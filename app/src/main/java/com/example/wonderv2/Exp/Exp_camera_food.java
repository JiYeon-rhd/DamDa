    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (result != null) {
            if (result.getContents() == null) {
                Toast.makeText(Exp_camera_food.this, "스캔취소", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Exp_camera_food.this, "스캔완료", Toast.LENGTH_SHORT).show();
                try {
                    //data를 json으로 변환
        ...
        mDatabase.child("exp_food").child(productName).setValue(Exp_productdetail)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Exp_camera_food.this, "저장을 완료했습니다.", Toast.LENGTH_SHORT).show();
                    }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(Exp_camera_food.this, "저장을 실패했습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        mDatabase.child("exp_food").child("1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue(Exp_productdetail.class) != null){
                    ...
                    Toast.makeText(Exp_camera_food.this, "데이터 없음", Toast.LENGTH_SHORT).show();
                }
            }
