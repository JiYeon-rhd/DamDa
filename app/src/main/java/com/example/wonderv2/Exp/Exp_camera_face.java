...
public class Exp_camera_face extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Exp_camera_face.this, MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (result != null) {
            if (result.getContents() == null) {
                Toast.makeText(Exp_camera_face.this, "스캔취소", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Exp_camera_face.this, "스캔완료", Toast.LENGTH_SHORT).show();
                try {
                    //data를 json으로 변환
    ...
    private void writeNewExp_productdetail(int a, String productName, String shopName, String expDay, String productDetail, String productIngredient, String productGuide, String dDay) {
        ...
        mDatabase.child("exp_face").child(productName).setValue(Exp_productdetail)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        // Write was successful!
                        Toast.makeText(Exp_camera_face.this, "저장을 완료했습니다.", Toast.LENGTH_SHORT).show();
                    }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(Exp_camera_face.this, "저장을 실패했습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void readExp_productdetail(){
        mDatabase.child("exp_face").child("1").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue(Exp_productdetail.class) != null){
                    ...
                    Toast.makeText(Exp_camera_face.this, "데이터 없음", Toast.LENGTH_SHORT).show();
                }
            }
